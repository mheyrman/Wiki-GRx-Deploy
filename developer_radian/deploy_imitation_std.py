...
motion_data = dp.import_reference_motions()
# TODO:
# - setup a parallel thread that handles motion loading w/ a getter function that 
#   iterates through the motions and switches to the default "demo_walk" if no motion is
#   being requested
# - has hardware e-stop -> is software e-stop needed?
...
def algorithm():
    ...
    policy_control_number_of_joint = 6 + 6 + 1 + 5 + 5  # left leg + right leg + waist + left arm + right arm
